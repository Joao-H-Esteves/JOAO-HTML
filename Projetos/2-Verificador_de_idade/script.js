     ...
     // res.innerHTML = `Idade calculada: ${idade}`
      ...
      //setAttribute == dar um id e o nome dele
        ...
        if (fsex[0].checked) {
            ...
            if (idade >=0 && idade <=6) {
                //CRIANÇA PEQUENA
                img.setAttribute('src','img/crianca_peq_masc.png');
                
                }else if (idade >=7 && idade <= 12) {
                    // CRIANÇA (GRANDE)
                    img.setAttribute('src','img/crianca_grande_masc.png');
                    ...
                    // ADOLECENTE
                    img.setAttribute('src','img/adolec_masc.png');

                }else if (idade <= 30){
                    // ADULTO JOVEM
                    img.setAttribute('src', 'img/adulto_jovem_masc.png');
                   
                }else if (idade <= 59){
                    // ADULTO MEDIO
                    img.setAttribute('src', 'img/adulto_medio_masc.png');
            ...
            if (idade >=0 && idade <=6) {
                //CRIANÇA PEQUENA
                img.setAttribute('src','img/crianca_peq_fem.png');

                }else if (idade >=7 && idade <= 12) {
                    // CRIANÇA (GRANDE)
                    img.setAttribute('src','img/crianca_grande_fem.png');

                }else if (idade <= 18) { // POR LÓGICA COMO ATE 12 É CRIANÇA, ENTÃ0 QUALQUER IDADE QUE FOR MENOR OU IGUAL A 18 JA SE ENCAIXA AQUI, POIS O PARAMETRO ACIMA JA ESTIPULA O QUE ACONTECE AO 12 OU MENOS.

                    // ADOLECENTE
                    img.setAttribute('src','img/adolec_fem.png');

                }else if (idade <= 30){
                    // ADULTO JOVEM
                    img.setAttribute('src', 'img/adulto_jovem_fem.png');

                }else if (idade <= 59){
                    // ADULTO MEDIO
                    img.setAttribute('src', 'img/adulto_medio_fem.png');
